...
MODEL_CLASSES = {
  ...
  "bloom": (BloomConfig, BloomForTokenClassification, BloomTokenizerFast),
}
...
def main():
  ...
  parser.add_argument("--model_name_or_path", default=None, type=str, required=True,
            help="Path to pre-trained model or shortcut name selected in the list: (without bigscience/) " + ", ".join(ALL_MODELS))
  ...
  parser.add_argument("--apply_qlora", action="store_true",
            help="Apply QLoRA adapter to model!")
  ...
  config = config_class.from_pretrained(args.config_name if args.config_name else model_path,
                      ...
                      cache_dir=args.cache_dir if args.cache_dir else None, **args_dict)
  tokenizer = tokenizer_class.from_pretrained(args.tokenizer_name if args.tokenizer_name else tokenizer_path,
