...
import os
from io import open
from transformers import XLMTokenizer, BloomTokenizerFast
...
def convert_examples_to_features(examples,
  ...
  for (ex_index, example) in enumerate(examples):
    ...
    for word, label in zip(example.words, example.labels):
      # deal with words inside a sentence
    ...
    if isinstance(tokenizer, BloomTokenizerFast):
